...
if(typeof define == 'function' && define.amd){
    ...
    define(['jquery', 'class', 'util'], factory);
    ...
    factory(window.jQuery, window.jQuery.klass, window.util);
}
})(function($, Class, Util){
var Suggestion = Class.$factory('suggestion', {
    ...
    init: function(){
        ...
        self.suggest = $('<ul class="ui3-suggestion"><li class="ui3-suggestion-header"></li><li class="ui3-suggestion-footer"></li></ul>').appendTo(self.parent);
        self.xhr = null;
        self.tid = null;
        self.index = null;
    ...
    initEvent: function(){
        ...
        self.dom.on('keyup paste cut', function(e){
            if(e.keyCode == 13){
                var $current = self.suggest.find('.ui3-suggestion-active');
        ...
        self.suggest.delegate('.ui3-suggestion-item', 'click', function(){
        ...
        self.suggest.find('.ui3-suggestion-header, .ui3-suggestion-footer').click(function(){
            self.dom.focus();
        });
    },
    ...
    switchKw: function(e){
        ...
        self.items.removeClass('ui3-suggestion-active');

        var $item = self.items.eq(index).addClass('ui3-suggestion-active');
    ...
    setHeader: function(header){
        var $header = this.suggest.find('.ui3-suggestion-header');
    ...
    setFooter: function(footer){
        var $footer = this.suggest.find('.ui3-suggestion-footer');
    ...
    build: function(data, kw){
        ...
        self.index = null;
        self.suggest.find('.ui3-suggestion-item').remove();
        self.finalData = data;
        ...
        if(!data.length){
            ...
            $.each(data, function(key, item){
                ...
                html += '<li class="ui3-suggestion-item" data-suggestion-index="' + key + '" data-suggestion-kw="' + txt + '">' + String(self.format(item, kw)) + '</li>';
            });

            self.items = $(html);
            self.suggest.find('.ui3-suggestion-header').after(self.items);
            self.open();
            self.trigger('build');
        }
    },
